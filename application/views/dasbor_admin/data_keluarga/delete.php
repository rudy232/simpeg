...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <a href="<?php echo base_url('dasbor_admin/data_pegawai/delete_keluarga/'.$data_pegawai_keluarga->id_data_keluarga.'/'.$data_pegawai_keluarga->id_data_pegawai)?>" class="btn btn-danger">
