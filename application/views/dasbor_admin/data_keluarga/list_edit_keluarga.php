<div class="span5">  
  <div class="widget-box">   
    ...
    <form class="form-horizontal" method="post" action="<?php echo base_url('dasbor_admin/dasbor/keluarga/').$data_keluarga_pegawai->id_data_keluarga.'/'.$data_keluarga_pegawai->id_data_pegawai ?>" name="basic_validate" id="basic_validate" novalidate="novalidate">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="no_ktp" value="<?php echo $data_keluarga_pegawai->no_ktp_keluarga ?>" id="required">
        </div>
      </div>
      <div class="control-group">
