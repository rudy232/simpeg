<form class="form-horizontal" method="post" action="<?php echo base_url('dasbor_admin/data_pegawai/tambah/'.$this->uri->segment(4)) ?>" name="basic_validate" id="basic_validate">
<div class="row-fluid">
  ...
  <div class="widget-box">   
    <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="tanggal_lahir" data-date-format="dd-mm-yyyy" class="datepicker span5" placeholder="Masukan Tanggal Lahir" id="date">
        </div>
      </div>
      <div class="control-group">
  ...
  <div class="widget-box">   
    ...
    <input type="hidden" name="id_data_pegawai" value="<?php echo $this->uri->segment(4) ?>">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="penempatan" placeholder="Masukan Penempatan" >
        </div>
      </div>
      <div class="control-group">
        <label class="control-label">Uraian</label>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="tanggal_sk" placeholder="Masukan Tanggal SK"  data-date-format="dd-mm-yyyy" class="datepicker span5" autocomplete="off">
        </div>
      </div>
      <div class="control-group">
        <label class="control-label">Tanggal Mulai</label>
        <div class="controls">
          <input type="text" name="tanggal_mulai" placeholder="Masukan Tanggal Mulai"  data-date-format="dd-mm-yyyy" class="datepicker span5" autocomplete="off">
        </div>
      </div>
      <div class="control-group">
        <label class="control-label">Tanggal Selesai</label>
        <div class="controls">
          <input type="text" name="tanggal_selesai" placeholder="Masukan Tanggal Selesai"  data-date-format="dd-mm-yyyy" class="datepicker span5" autocomplete="off" />
        </div>
      </div>
      <div class="control-group">
        <label class="control-label">Lokasi</label>
        <div class="controls">
          <input type="text" name="lokasi" placeholder="Masukan Tanggal Lokasi" >
        </div>
      </div>
      <div class="form-actions">
  ...
  <div class="widget-box">   
    ...
    <input type="hidden" name="id_data_pegawai" value="<?php echo $this->uri->segment(4) ?>">
      ...
      <div class="control-group">
        <label class="control-label">Tanggal Sk</label>
        <div class="controls">
          <input type="text" name="tanggal_sk_penghargaan" placeholder="Masukan Tanggal Selesai"  data-date-format="dd-mm-yyyy" class="datepicker span5" autocomplete="off" />
        </div>
      </div>
      <div class="control-group">
        <label class="control-label">Uraian</label>
  ...
  <div class="widget-box">   
    ...
    <input type="hidden" name="id_data_pegawai" value="<?php echo $this->uri->segment(4) ?>">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="sekolah" placeholder="Masukan Sekolah" >
        </div>
      </div>
      <div class="control-group">
        <label class="control-label">Tempat Sekolah</label>
        <div class="controls">
          <input type="text" name="tempat_sekolah" placeholder="Masukan Tempat Sekolah" >
        </div>
      </div>
      <div class="control-group">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="tanggal_sttb" placeholder="Masukan Tanggal STTB"  data-date-format="dd-mm-yyyy" class="datepicker span5" autocomplete="off">
        </div>
      </div>
      <div class="control-group">
        <label class="control-label">Tanggal Lulus</label>
        <div class="controls">
          <input type="text" name="tanggal_lulus" placeholder="Masukan Tanggal Lulus"  data-date-format="dd-mm-yyyy" class="datepicker span5" autocomplete="off">
        </div>
      </div>
      <div class="form-actions">
  ...
  <div class="widget-box">   
    ...
    <input type="hidden" name="id_data_pegawai" value="<?php echo $this->uri->segment(4) ?>">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="tanggal_sertifikat" placeholder="Masukan Tanggal Sertifikat" data-date-format="dd-mm-yyyy" class="datepicker span5" autocomplete="off">
        </div>
      </div>
      <div class="control-group">
        <label class="control-label">Jam Pelatihan</label>
        <div class="controls">
          <input type="text" name="jam_pelatihan" placeholder="Masukan Tempat Sekolah" >
        </div>
      </div>
      <div class="control-group">
  ...
  <div class="widget-box">   
    ...
    <input type="hidden" name="id_data_pegawai" value="<?php echo $this->uri->segment(4) ?>">
      ...
      <div class="control-group">
        <label class="control-label">Tanggal SK</label>
        <div class="controls">
          <input type="text" name="tanggal_sk_hukuman" placeholder="Masukan Tanggal SK"  data-date-format="dd-mm-yyyy" class="datepicker span5" autocomplete="off">
        </div>
      </div>
      <div class="control-group">
        <label class="control-label">Tanggal Mulai</label>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="masa_berlaku" placeholder="Masukan Masa Berlaku Hukuman"   data-date-format="dd-mm-yyyy" class="datepicker span5" autocomplete="off">
        </div>
      </div>
      <div class="control-group">
