  ...
  <div class="widget-content nopadding">
    <table class="table table-bordered data-table">
      ...
      <tbody>
        ...
        <tr>
          <td><?php echo $i ?></td>
          <td><?php if($data_pegawai->nip==""){ echo $data_pegawai->nopeg; }else{ echo $data_pegawai->nrk;} ?></td>
