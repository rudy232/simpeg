<?php 
  ...
  echo form_open(base_url('dasbor_admin/cuti/edit'));
?>
<div class="row-fluid">
  ...
  <div id="tab1" class="tab-pane active">
    <table class="table table-bordered">
      <tr>
        ...
        <td>:</td>
        <td><input type="text" name="tanggal_pengajuan" id="tanggal_pengajuan" class="span5 tanggal_pengajuan" value="<?php echo $data_cuti->tanggal_pengajuan ?>" readonly/></td>
      </tr>
      <tr>
        <td><label>Bulan Surat</label></td>
        <td>:</td>
        <td><input type="text" name="bulan_surat" id="bulan_surat" class="span5 bulan_surat" value="<?php echo $data_cuti->bulan_surat ?>" readonly/></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>:</td>
        <td>
          <select name='hari_libur' class="span5" required="required">
      ...
      <tr>
        ...
        ?>
          <option value="<?php echo $list_pegawai->nama ?>" nip="<?php echo $list_pegawai->nip ?>" pangkat="<?php echo $list_pegawai->pangkat ?>"><?php echo $list_pegawai->nama ?></option>
        <?php
          }
        ?>
        </select>
