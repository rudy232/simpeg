<button class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete_pendidikan<?php echo $i ?>">
<i class="icon-trash"></i>
</button>
<div class="modal fade" id="delete_pendidikan<?php echo $i ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
