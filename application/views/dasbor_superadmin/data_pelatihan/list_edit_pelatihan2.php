...
<div class="span5">  
  <div class="widget-box">   
    ...
    <form class="form-horizontal" method="post" action="<?php echo base_url('dasbor_superadmin/data_pegawai/pelatihan2/').$data_riwayat_pelatihan->id_data_pelatihan.'/'.$data_riwayat_pelatihan->id_data_pegawai ?>" name="basic_validate" id="basic_validate" novalidate="novalidate">
