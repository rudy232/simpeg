...
?>
<?php 
  echo form_open(base_url('dasbor_superadmin/master_pelatihan/tambah'));
?>
<div class="row-fluid">
  ...
  <div id="tab1" class="tab-pane active">
    <table class="table table-bordered">
      <tr>
        ...
        <td>:</td>
        <td><input type="text" name="nama_pelatihan" id="nama_pelatihan" class="span5 nama_pelatihan" placeholder="Masukan Nama Pelatihan"/></td>
      </tr>
    </table>
