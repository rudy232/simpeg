...
<?php 
  ...
  echo form_open(base_url('dasbor_superadmin/kirim_pesan/kirim_pesan'));
?>
<div class="row-fluid">
  ...
  <div id="tab1" class="tab-pane active">
    ...
    <table class="table table-bordered">
      ...
      <tr>
        ...
        <td>:</td>
		    <td>
          <select name="ke" id="ke" class="span5 ke" data-placeholder="Masukan Nama Tujuan">
            <option></option>
            <?php
      ...
      <tr>
        ...
        <td>:</td>
          ...
          <select name="jenis_pesan" class="span5">
			       ...
			       <option value="Instruksi Atasan">Instruksi Atasan</option>
