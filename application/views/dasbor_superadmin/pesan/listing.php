  		...
  		<div class="widget-content padding">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><strong><a href="<?php echo base_url('dasbor_superadmin/kirim_pesan/detail_pesan/'.$list_pesan->id) ?>" style="text-decoration: underline;color: blue;"><?php echo $list_pesan->judul ?></a></strong></td>
