...
<?php 
  ...
  echo form_open(base_url('dasbor_superadmin/data_pegawai/proses_tambah_pegawai/Null'));
?>
<div class="row-fluid">
<div class="widget-box">
<div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#tab1">Tambah Data Pegawai</a></li>
  </ul>
</div>
  ...
  <div id="tab1" class="tab-pane active">
    <table class="table table-bordered">
      ...
      <tr>
        ...
        <td>:</td>
        <td><input type="text" name="nama" id="nama" class="span5 nama" placeholder="Masukan Nama Pegawai" /></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>:</td>
        <td><input type="text" name="nip_pegawai" id="nip_pegawai" class="span5 nip_pegawai" placeholder="NIP Pegawai" /><br/><span class="btn btn-danger">Lewati inputan NIP jika bukan PNS</span><div id="errmsg"></div></td>
      </tr>
      <tr>
        <td><label>NRK</label></td>
        <td>:</td>
        <td><input type="text" name="nrk_pegawai" id="nrk_pegawai" class="span5 nrk_pegawai" placeholder="NRK Pegawai" /><br/><span class="btn btn-danger">Lewati inputan NRK jika bukan PNS</span><div id="errmsgnrk"></div></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>:</td>
        <td><input type="text" name="nopeg" id="nopeg" class="span5 nopeg" placeholder="Masukan Nomor Pegawai"><div id="errmsgnopeg"></div></td>
      </tr>
      <tr>
        <td><label>Password</label></td>
        <td>:</td>
        <td><input type="password" name="password" id="password" class="span5 password" placeholder="Masukan password" /></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>:</td>
        <td><input type="text" name="email" id="email" class="span5 email"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>:</td>
        <td><input type="text" name="tanggal_daftar" data-date="<?php echo date("d-m-Y") ?>" data-date-format="dd-mm-yyyy" class="datepicker span5" autocomplete="off"></td>
      </tr>
      <tr>
        <td><label>Tahun Masa Kerja</label></td>
        <td>:</td>
        <td><input type="text" name="tahun_masa_kerja" id="tahun_masa_kerja" class="span5 tahun_masa_kerja" placeholder="Masukan Tahun Masa Kerja" required /><br/><span class="btn btn-danger">Masukan angka 0 jika belum ada 1 tahun masa kerja</span><div id="errmsgtahun_masa_kerja"></div></td>
      </tr>
      <tr>
        <td><label>Bulan Masa Kerja</label></td>
        <td>:</td>
        <td><input type="text" name="bulan_masa_kerja" id="bulan_masa_kerja" class="span5 bulan_masa_kerja" placeholder="Masukan Bulan Masa Kerja" /><br/><span class="btn btn-danger">Masukan angka 0 jika belum ada 1 tahun masa kerja</span><div id="errmsgbulan_masa_kerja"></div></td>
      </tr>
      <tr>
        <td><label>Tempat Lahir</label></td>
        <td>:</td>
        <td><input type="text" name="tempat_lhr" id="tempat_lhr" class="span5 tempat_lhr" placeholder="Masukan Tempat Lahir"  required="required"/></td>
      </tr>
      <tr>
        <td><label>Tanggal Lahir</label></td>
        <td>:</td>
        <td><input type="text" name="tgl_lahir" data-date="<?php echo date("d-m-Y") ?>" data-date-format="dd-mm-yyyy" class="datepicker span5" autocomplete="off"></td>
      </tr>
      <tr>
        <td><label>Alamat</label></td>
        <td>:</td>
        <td><input type="text" name="alamat" id="alamat" class="span5 alamat" placeholder="Masukan Alamat Lengkap"  required="required"/></td>
      </tr>
      <tr>
        <td><label>Nomor Rekening</label></td>
        <td>:</td>
        <td><input type="text" name="no_rekening" id="no_rekening" class="span5 no_rekening" placeholder="Masukan Nomor Rekening"/><br/><span class="btn btn-danger">Lewati inputan nomor rekening jika belum memiliki rekening</span><div id="errmsgnorekening"></div></td>
      </tr>
      <tr>
        <td><label>Nomor KTP</label></td>
        <td>:</td>
        <td><input type="text" name="no_ktp" id="no_ktp" class="span5 no_ktp" placeholder="Masukan Nomor KTP"/><br/><span class="btn btn-danger">Lewati inputan nomor ktp jika belum memiliki ktp</span><div id="errmsgnoktp"></div></td>
      </tr>
      <tr>
        <td><label>Nomor NPWP</label></td>
        <td>:</td>
        <td><input type="text" name="no_npwp" id="no_npwp" class="span5 no_npwp" placeholder="Masukan Nomor NPWP"/><br/><span class="btn btn-danger">Lewati inputan nomor npwp jika belum memiliki npwp</span><div id="errmsgnonpwp"></div></td>
      </tr>
      <tr>
        <td><label>Nomor HP</label></td>
        <td>:</td>
        <td><input type="text" name="no_hp" id="no_hp" class="span5 no_hp" placeholder="Masukan Nomor HP"/><br/><span class="btn btn-danger">Lewati inputan nomor hp jika belum memiliki hp</span><div id="errmsgnohp"></div></td>
      </tr>
      <tr>
        <td><label>Jenis Tunjangan</label></td>
        <td>:</td>
        <td>
          <select name="jenis_tunjangan" id="jenis_tunjangan" class="span5 jenis_tunjangan" data-placeholder="Masukan Jenis Tunjangan" required>
            <option></option>
            <?php 
      ...
      <tr>
        ...
        <td>:</td>
        <td><input type="text" name="status_tunjangan" id="status_tunjangan" class="span5 status_tunjangan" readonly  required="required"></td>
      </tr>
      <tr>
        <td><label>Pendidikan Terakhir</label></td>
        <td>:</td>
        <td><input type="text" name="pendidikan_trkh" id="pendidikan_trkh" class="span5 pendidikan_trkh" readonly  required="required"></td>
      </tr>
      <tr>
        <td><label>Gaji</label></td>
        <td>:</td>
        <td><input type="text" name="gaji" id="gaji" class="span5 gaji" readonly  required="required"></td>
      </tr>
      <tr>
