...
<?php 
  ...
  echo form_open(base_url('dasbor_superadmin/cuti/edit'));
?>
<div class="row-fluid">
  ...
  <div id="tab1" class="tab-pane active">
    <table class="table table-bordered">
      <tr>
        ...
        <input type="hidden" name="id_data_pegawai" id="id_data_pegawai" class="span5 id_data_pegawai" value="<?php echo $data_cuti->id_data_pegawai ?>" />
