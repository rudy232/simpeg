...
<?php 
  ...
  echo form_open(base_url('dasbor_superadmin/cuti/tambah_cuti_alasan_penting'));
?>
<div class="row-fluid">
  ...
  <div id="tab1" class="tab-pane active">
    ...
    <table class="table table-bordered">
      ...
      <tr>
        ...
        <td>:</td>
        <td><input type="text" name="alasan_cuti" id="alasan_cuti" class="span5 alasan_cuti" placeholder="Masukan Alasan Cuti" required /></td>
      </tr>
    </table>
