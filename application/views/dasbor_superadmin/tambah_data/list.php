...
?>
<form class="form-horizontal" method="post" action="<?php echo base_url('dasbor_superadmin/data_pegawai/tambah/'.$this->uri->segment(4)) ?>" name="basic_validate" id="basic_validate">
<div class="row-fluid">
  ...
  <div class="widget-box">   
    ...
    <input type="hidden" name="id_data_pegawai" value="<?php echo $this->uri->segment(4) ?>">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="tanggal_mou" placeholder="Masukan Tanggal MOU"  data-date-format="dd-mm-yyyy" class="datepicker span5" autocomplete="off" />
        </div>
      </div>
      <div class="form-actions">
  ...
  <div class="widget-box">   
    ...
    <input type="hidden" name="id_data_pegawai" value="<?php echo $this->uri->segment(4) ?>">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="tanggal_exp_str" placeholder="Masukan Exp STR"  data-date-format="dd-mm-yyyy" class="datepicker span5" autocomplete="off">
        </div>
      </div>
      <div class="control-group">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="tanggal_exp_sip" placeholder="Masukan Exp SIP"  data-date-format="dd-mm-yyyy" class="datepicker span5" autocomplete="off">
        </div>
      </div>
      <div class="control-group">
