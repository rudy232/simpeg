<div class="span5">  
  <div class="widget-box">   
    ...
    <form class="form-horizontal" method="post" action="<?php echo base_url('dasbor_admin/dasbor/edit/').$data_pegawai->id_data_pegawai ?>" name="basic_validate" id="basic_validate" novalidate="novalidate">
      <div class="control-group">
        <label class="control-label">No Pegawai</label>
        <div class="controls">
          <input type="text" name="nip" value="<?php echo $data_pegawai->nip ?>" id="required">
        </div>
      </div>
      <div class="control-group">
